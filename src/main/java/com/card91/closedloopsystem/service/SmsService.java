...
import com.card91.closedloopsystem.dto.OtpStatus;
...
public class SmsService {
	...
	public OtpResponseDto sendSMS(OtpRequest otpRequest) {
		...
		try {
			...
			System.out.println("Inside method.to number is : " + to);
			System.out.println("Inside method. from number is : " + from);
			String otp = generateOTP();
			System.out.println("Inside method.otp is" + otp);
